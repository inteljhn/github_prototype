...
//	private HttpSession session;
	...
	// 2024-01-26. planthoon.
	// TODO - Entity 클래스를 그대로 request 파라미터로 사용하지 말고 
	// 화면에서 실제 입력할 수 있는 필드들만을 속성으로 갖는 DTO를 별도로 만들어서 유효성 검사 구현 필요
	@PostMapping("/auth/joinProc")
	public ResponseDto<?> save(
		//@RequestBody User user,
		@Valid  @RequestBody JoinReqDto user,
