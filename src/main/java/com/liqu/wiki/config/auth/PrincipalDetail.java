...
// Spring Security가 로그인 요청을 가로채서 로그인을 진행하고 
// 완료되면 UserDetails 타입의 오브젝트를 Spring Security의 고유한 세션 저장소에 저장해준다.
...
public class PrincipalDetail implements UserDetails{
	 ...
	 * 
	 * 권한이 여러개 있을 수 있어서 루프를 돌아야 하는데 일단 하나만 사용
	 */
	@Override
	public Collection<? extends GrantedAuthority> getAuthorities() {
		...
		collectors.add(new GrantedAuthority() {
			...
			public String getAuthority() {
				// 권한 문자열 앞에 prefix(접두어) "ROLE_" 필수. Spring Security에서의 규칙. 
